<?php if(count($free_course_list) > 0){?>
<div class="row course-container">
    <?php
        if(count($free_course_list ) <= 4){
            $marginTop = '40px';
        }else{
            $marginTop = '0';
        }
    ...
    <div class="col uk-section" style="margin-bottom: <?= $marginTop?>">
         <div style="overflow: hidden;">
            <h2 style="float: left;" id="title">Free Courses </h2> 

            <?php
                if(count($free_course_list) > 4){
            ?>
            <span class="view-all" style="float: right;"><a href="<?= base_url('home/courses?category=&category_name=free')?>">View All</a></span>
        <?php }?>

        </div>
        <div class="owl-carousel owl-theme">
            <?php foreach ($free_course_list as $course) {
        if ($course->status) {
            ?>
        <div class="item">
          ...
          <div class="item mx-auto item-inline">
                 <div class="uk-card uk-card-primary uk-card-hover uk-card-body uk-light">
                     <p><a href="<?= base_url('home/courses?category=&category_name=free')?>">View All</a></p>
                 </div>
