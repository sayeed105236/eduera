<?php if(count($mock_test_course_list) > 0){?>

<div class="row course-container">
    <?php
        if(count($mock_test_course_list ) <= 4){
            $marginTop = '40px';
        }else{
            $marginTop = '0';
        }
    ...
    <div class="col uk-section" style="margin-bottom: <?= $marginTop?>">
        <div style="overflow: hidden;">
            <h2 style="float: left;" id="title">Practice Exams</h2> 
          <?php
                if(count($mock_test_course_list) > 4){
            ?>
            <span class="view-all" style="float: right;"><a href="<?= base_url('home/courses?category=&category_name=mock_test')?>">View All</a></span>
        <?php }?>

       </div>
        <div class="owl-carousel owl-theme">
            <?php foreach ($mock_test_course_list as $course) {
        if ($course->status) {
            ?>
        <div class="item">
                            ...
                            <a href="<?=base_url('course/' . $course->slug)?>">
                                ...
                                <div class="tile-secondary-content tile-inline">
                                  ...
                                  <?php endif;?>
                                    ...
                                    <a href="<?php echo site_url('home/course/' . $course->slug); ?>">

                                 <br><a href="<?php echo site_url('home/course/' . $course->slug); ?>" class="title"><?php echo $course->title; ?></a>
          ...
          <div class="item mx-auto item-inline">
                 <div class="uk-card uk-card-primary uk-card-hover uk-card-body uk-light">
                     <p><a href="<?= base_url('home/courses?category=&category_name=mock_test')?>">View All</a></p>
                 </div>
