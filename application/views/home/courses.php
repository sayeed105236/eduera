        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="category-course-list">
                    <div class="row cat-list-inline">
                        <div class="col-md-4 text-left">
                            <h5>Select Course</h5>
                        </div>
                        <div class="col-md-8" >
                            <?php foreach($home_page_setting as $home){?>
                            <div class="form-check form-check-inline text-right" style="margin-right: 0; padding-right: 9px;">
                                <input class="form-check-input" <?php if(isset($_GET['category_name'])){if($home->slug == $_GET['category_name']){?> checked <?php }}?> type="radio" name="inlineRadioOptions" id="course_category_<?= $home->id?>" value="<?= $home->slug?>"  onclick="selectCourseCategory(<?= $home->id?>)">
                                <label class="form-check-label" for="inlineRadio1" style="color: black"><?= $home->name?></label>
                            </div>
                            <?php } ?>
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding: 5px 10px;">
                        ...
                        <!-- <div class="col-md-4 col-lg-4  col-sm-6"> -->
                            ...
                            <div class="course-box-wrap col-md-4 col-lg-4" style="padding: 0px 5px;">
                                <div class="middle">
                                ...
                                <a href="<?=base_url('course/' . $course->slug)?>">
                                    <div class="course-box">
                                        ...
                                        <div class="course-details">
                                            ...
                                            <?php if (($course->discount_flag && $course->discounted_price == 0) || $course->price == 0): ?>
...
<script type="text/javascript">
    ...
    function selectCourseCategory(id){
        
        category = '<?= isset($_GET['category']) ? $_GET['category'] : ''?>';
        category_name =  $("#course_category_"+id).val();

        
            url = 'category='+category+ '&category_name='+category_name;
            window.location.href = '<?=base_url('home/courses?')?>' + url;
