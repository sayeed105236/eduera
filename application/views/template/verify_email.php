							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
										You are receiving this email because we received a verify account request for your eduera account.
									</td>
								...
								<tr>
									<td>
										<p>Please click the button below to verify youir eduera account:</p>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="button" >
					                    <a style="background-color: #1a6596" class="link" href="<?=base_url('login/verify_email_address/' . $user_data['verification_code'])?>" target="_blank">
					                          Active your account
					                    </a>
				                   </td>
								...
								<tr>
									...
									<tr>
										<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
											If you did not request an account activation, no further action is required.
										</td>
									</tr>
									<tr>
