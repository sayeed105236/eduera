							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
										...
										Congratulations, you unlocked your certificate of completion for <span style="color: #105ae3"> "<?=$course_details->title?>"</span>.
									</td>
                                ...
                                <tr>
									<td class="button">
										<a class="button" style="background-color: #1a6596" class="link" href="<?=base_url('user/load_certificate/' . $course_details->id.'/'.$user_data->id)?>" target="_blank">
					                          View Certificate
					                    </a>
									</td>
								</tr>
