...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-12">
                <h5><?= count($question_list) ?> total questions</h5>
                    <div class="row">
                          <form method="post" action="<?= base_url('instructor/save_question_for_course/'.$course_info->id)?>"> 
                          ...
                          <div style="height:600px;overflow:auto; margin-top: 20px;" >  
                           ...
                           <button class="btn btn-info" type="submit" style="margin-top: 20px;">Submit</button>
                          </form>  
